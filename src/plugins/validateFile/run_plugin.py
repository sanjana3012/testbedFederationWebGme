"""
This script is called by the plugin-wrapper, validateFile.js, which passes down the
...
from validateFile import validateFile
...
plugin = validateFile(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
