"""
This script is called by the plugin-wrapper, createFabFile.js, which passes down the
...
from createFabFile import createFabFile
...
plugin = createFabFile(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
