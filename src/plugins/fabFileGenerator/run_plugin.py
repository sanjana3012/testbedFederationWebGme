"""
This script is called by the plugin-wrapper, fabFileGenerator.js, which passes down the
...
from fabFileGenerator import fabFileGenerator
...
plugin = fabFileGenerator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
