"""
This script is called by the plugin-wrapper, createCredentialFile.js, which passes down the
...
from createCredentialFile import createCredentialFile
...
plugin = createCredentialFile(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
